...
import { Search, ArrowRight, Grid3X3, List, SlidersHorizontal, X, Tag, Sparkles } from "lucide-react";
...
const ALL_CATEGORIES = [...new Set(getServices().map((s) => s.category))].sort();
...
export default function Catalog() {
  ...
  // Get services from localStorage (automatically seeded on first load)
  ...
  const filteredServices = useMemo(() => {
    ...
    return result;
  }, [services, search, selectedCategory, sortBy, priceRange]);
